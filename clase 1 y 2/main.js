...
const material = new THREE.MeshStandardMaterial({ color: #18D9C6});
const cube = new THREE.Mesh(geometry, material);
scene.add(cube);


const material2 = new THREE.MeshStandardMaterial({ color: #A1ABAA});
const cube2= new THREE.Mesh(geometry, material2);
cube2.position.x = 2;
scene.add(cube2);

const material3 = new THREE.MeshStandardMaterial({ color: #E6E6E6});
